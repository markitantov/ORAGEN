...
def main(d_config: dict, t_config: dict) -> None:
    ...
    experiment_name = 'w-{4}MultiModalFinalBM{3}-{0}-{1}-{2}'.format(len(c_names['gen']),
    ...
    model = model_cls(features_type=features_type)
    model.to(device)
...
def run_training() -> None:
    ...
    features_types = [FeaturesType.INTERMEDIATE, FeaturesType.LATE]
